...
import * as nodeFirebaseActions from './node-firebase-actions'
...
export const generateEventsForReassignParentNode = (dispatch, nodeId, oldParentId, newParentId, addAfterSiblingId, appState) => {
  ...
  dispatch(nodeFirebaseActions.reassignParentNode(nodeId, oldParentId, newParentId, updatedChildIdsForOldParent, updatedChildIdsForNewParent, appState.auth.id))
