...
describe('getNextNodeThatIsVisible', () =>{
  ...
  it('should return the sibling nodeId above, if searching above and it is visible', () => {
    const nodeAboveiii = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'iii', true),
          nodeAbovefff = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'fff', true),
          nodeAbovebbb = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'bbb', true);
  ...
  it('should return the sibling nodeId below, if searching below and it is visible', () => {
    const nodeBelowiii = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'iii', false),
          nodeBelowbbb = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'bbb', false),
          nodeBelowccc = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'ccc', false),
          nodeBelowddd = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'ddd', false),
          nodeBelowggg = treeQueries.getNextNodeThatIsVisible('aaa', appState.nodes, 'ggg', false);
