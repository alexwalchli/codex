import React, { PropTypes } from 'react' // eslint-disable
...
const MentionsInput = React.createClass({
  ...
  addMention: function (ev, suggestion, {mentionDescriptor, querySequenceStart, querySequenceEnd, plainTextValue}) {
